# Chinese Word Generator API

This model service example is fork and edit from [Morizeyao/GPT2-Chinese](https://github.com/Morizeyao/GPT2-Chinese)
...
```
mkdir data
mv train.json data/train.json
```


Put data in data/train.json
Use the Data format like the following in chinese:

```
input[emotion]output
```
...
```
python train.py --epochs 1 --output_dir model/ \
--raw_data_path data/train.json --num_pieces 100 \
--batch_size 4 --min_length 1 --log_step 1000 \
--warmup_steps 20000 --stride 512 \
--raw
```

After training is finish, you will see the following output:

```
time: 2021-04-02 00:22:06.732917
saving model for epoch 1
epoch 1 finished
time: 2021-04-02 00:22:07.277885
time for one epoch: 0:00:00.544968
training finished
```
...
Then go to http://localhost:8081/docs#/default/generateText_generate_text__get<br>
To test the model.

BE PAITENT. You might need to train many hours to get a satisfied generation.
